...
│   ├── routes/
│   │   ├── user.js                  # User auth & course routes
│   │   ├── admin.js                 # Admin auth & course management
│   │   ├── course.js                # Course purchase & lesson routes
│   │   └── review.js                # Review CRUD routes
│   ├── validations/
│   │   ├── userValidation.js
│   │   ├── userSignInValidation.js
│   │   ├── adminValidation.js
│   │   ├── adminSignInValidation.js
│   │   └── courseValidation.js
...
└── frontend/
    ...
    │   │   ├── ViewCourseCard.jsx   # User course card
    │   │   └── ProfileCard.jsx
    │   ├── pages/
    │   │   ├── Home.jsx
    │   │   ├── SignIn.jsx
